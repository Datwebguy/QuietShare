...
func deployFreshInstructionSender(t *testing.T) (common.Address, *quietshare.QuietShareInstructionSender) {
	t.Helper()
	time.Sleep(rpcDelay)
...
func deployInstructionSenderRaw(t *testing.T, registryAddr, machineRegistryAddr common.Address) error {
	...
	_, _, _, err = quietshare.DeployQuietShareInstructionSender(
		opts, testSupport.ChainClient,
